...
@section('dashboard-employee-content')
    <div class="page-header" style="display: flex; align-items: center; justify-content: space-between">
        ...
        <div class="btn-group">
            ...
            <a class="btn btn-xs btn-primary" href="{{ route('leaves.create') }}">
    ...
    @foreach ($leaveData as $value)
        <div id="Comments{{ $value->id }}" class="modal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">

                        <h4 class="blue bigger"><i class="far fa-eye"></i>Comments</h4>
                    </div>
